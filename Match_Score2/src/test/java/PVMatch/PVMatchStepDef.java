...
public class PVMatchStepDef {
	...
	public void start_the_browser() throws Throwable {
		...
		// System.setProperty("webdriver.chrome.driver","/Users/reenupanwar/Desktop/Selenium
		// Software/chromedriver 4");
	...
	public void click_on_matchscore_button() throws Throwable {
		...
		//driver.findElement(By.xpath("//div[@class='match-stats']")).click();
	...
	@Then("^Save the matchscore for the user$")
	public void save_the_matchscore_for_the_user() throws Throwable {
