...
public class DataStepDefinition {
	...
	public void Fill_the_all_required_fields(DataTable table) throws Throwable {
		...
		Gender.selectByVisibleText(data.get(7).get(1));
		
		
		driver.findElement(By.xpath("")).sendKeys(data.get(8).get(1));  
	...
	public void Enter_the_correct_username_and_password() throws Throwable {
		...
		driver.findElement(By.name("username")).sendKeys("arun22");
		driver.findElement(By.id("password")).sendKeys("slabacad");
	    
	}

	@Then("^Click on the submit button$")
	public void Clickonthesubmitbutton() throws Throwable {
	    driver.findElement(By.xpath(".//*[@id='login-modal']/div[2]/div/pv-login/div/div/form/div[1]/div[4]/div[2]/button")).click();
	}
